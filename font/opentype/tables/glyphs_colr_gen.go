...
func (item *PaintComposite) mustParse(src []byte) {
	_ = src[7] // early bound checking
	item.format = src[0]
	item.SourcePaintOffset[0] = src[1]
	item.SourcePaintOffset[1] = src[2]
	item.SourcePaintOffset[2] = src[3]
	item.CompositeMode = src[4]
	item.BackdropPaintOffset[0] = src[5]
	item.BackdropPaintOffset[1] = src[6]
	item.BackdropPaintOffset[2] = src[7]
}

func (item *PaintGlyph) mustParse(src []byte) {
	_ = src[5] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
	item.PaintOffset[2] = src[3]
	item.GlyphID = binary.BigEndian.Uint16(src[4:])
}

func (item *PaintLinearGradient) mustParse(src []byte) {
	_ = src[15] // early bound checking
	item.format = src[0]
	item.ColorLineOffset[0] = src[1]
	item.ColorLineOffset[1] = src[2]
	item.ColorLineOffset[2] = src[3]
...
func (item *PaintRadialGradient) mustParse(src []byte) {
	_ = src[15] // early bound checking
	item.format = src[0]
	item.ColorLineOffset[0] = src[1]
	item.ColorLineOffset[1] = src[2]
...
func (item *PaintRotate) mustParse(src []byte) {
	_ = src[5] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
	item.PaintOffset[2] = src[3]
	item.Angle = Fixed214(binary.BigEndian.Uint16(src[4:]))
}

func (item *PaintRotateAroundCenter) mustParse(src []byte) {
...
func (item *PaintScale) mustParse(src []byte) {
	_ = src[7] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
	item.PaintOffset[2] = src[3]
	item.ScaleX = Fixed214(binary.BigEndian.Uint16(src[4:]))
	item.ScaleY = Fixed214(binary.BigEndian.Uint16(src[6:]))
}

func (item *PaintScaleAroundCenter) mustParse(src []byte) {
...
func (item *PaintScaleUniform) mustParse(src []byte) {
	_ = src[5] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
	item.PaintOffset[2] = src[3]
	item.Scale = Fixed214(binary.BigEndian.Uint16(src[4:]))
}

func (item *PaintScaleUniformAroundCenter) mustParse(src []byte) {
	_ = src[9] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
...
func (item *PaintSkew) mustParse(src []byte) {
	_ = src[7] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
	item.PaintOffset[2] = src[3]
	item.XSkewAngle = Fixed214(binary.BigEndian.Uint16(src[4:]))
	item.YSkewAngle = Fixed214(binary.BigEndian.Uint16(src[6:]))
}

func (item *PaintSkewAroundCenter) mustParse(src []byte) {
	_ = src[11] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
...
func (item *PaintSolid) mustParse(src []byte) {
	...
	item.Alpha = Fixed214(binary.BigEndian.Uint16(src[3:]))
}

func (item *PaintSweepGradient) mustParse(src []byte) {
	_ = src[11] // early bound checking
	item.format = src[0]
	item.ColorLineOffset[0] = src[1]
	item.ColorLineOffset[1] = src[2]
	...
	item.StartAngle = Fixed214(binary.BigEndian.Uint16(src[8:]))
	item.EndAngle = Fixed214(binary.BigEndian.Uint16(src[10:]))
}

func (item *PaintTransform) mustParse(src []byte) {
	_ = src[6] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
	item.PaintOffset[2] = src[3]
	item.TransformOffset[0] = src[4]
	item.TransformOffset[1] = src[5]
	item.TransformOffset[2] = src[6]
}

func (item *PaintTranslate) mustParse(src []byte) {
	_ = src[7] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
...
func (item *PaintVarLinearGradient) mustParse(src []byte) {
...
func (item *PaintVarRadialGradient) mustParse(src []byte) {
	_ = src[19] // early bound checking
	item.format = src[0]
	item.ColorLineOffset[0] = src[1]
	item.ColorLineOffset[1] = src[2]
...
func (item *PaintVarRotate) mustParse(src []byte) {
	_ = src[9] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
...
func (item *PaintVarRotateAroundCenter) mustParse(src []byte) {
...
func (item *PaintVarScale) mustParse(src []byte) {
	_ = src[11] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
...
func (item *PaintVarScaleAroundCenter) mustParse(src []byte) {
	_ = src[15] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
...
func (item *PaintVarScaleUniform) mustParse(src []byte) {
	_ = src[9] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
...
func (item *PaintVarScaleUniformAroundCenter) mustParse(src []byte) {
	_ = src[13] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
...
func (item *PaintVarSkew) mustParse(src []byte) {
	_ = src[11] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
...
func (item *PaintVarSkewAroundCenter) mustParse(src []byte) {
	_ = src[15] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
...
func (item *PaintVarSweepGradient) mustParse(src []byte) {
	_ = src[15] // early bound checking
	item.format = src[0]
	item.ColorLineOffset[0] = src[1]
	item.ColorLineOffset[1] = src[2]
...
func (item *PaintVarTransform) mustParse(src []byte) {
	_ = src[6] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
...
func (item *PaintVarTranslate) mustParse(src []byte) {
	_ = src[11] // early bound checking
	item.format = src[0]
	item.PaintOffset[0] = src[1]
	item.PaintOffset[1] = src[2]
