...
<<<<<<<< HEAD:internal/unicodedata/line_break_test.go
========
...
>>>>>>>> main:internal/unicodedata/line_break.go
...
// Aksara
var BreakAK = &unicode.RangeTable{
	R16: []unicode.Range16{
	...
	R32: []unicode.Range32{
		{Lo: 0x11005, Hi: 0x11037, Stride: 1},
		{Lo: 0x11071, Hi: 0x11072, Stride: 1},
		{Lo: 0x11075, Hi: 0x11305, Stride: 656},
		{Lo: 0x11306, Hi: 0x1130c, Stride: 1},
		...
		{Lo: 0x11360, Hi: 0x11361, Stride: 1},
		{Lo: 0x11392, Hi: 0x113b5, Stride: 1},
...
var BreakAL = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1093f, Hi: 0x10959, Stride: 1},
		...
		{Lo: 0x10ed1, Hi: 0x10ed8, Stride: 1},
		...
		{Lo: 0x11bc0, Hi: 0x11be1, Stride: 1},
		...
		{Lo: 0x11d98, Hi: 0x11db0, Stride: 24},
		{Lo: 0x11db1, Hi: 0x11ddb, Stride: 1},
		...
		{Lo: 0x16d40, Hi: 0x16d6d, Stride: 1},
		...
		{Lo: 0x18cff, Hi: 0x1aff0, Stride: 8945},
		...
		{Lo: 0x1bc9c, Hi: 0x1cc00, Stride: 3940},
		{Lo: 0x1cc01, Hi: 0x1ccef, Stride: 1},
		{Lo: 0x1ccfa, Hi: 0x1ccfc, Stride: 1},
		{Lo: 0x1cd00, Hi: 0x1ceb3, Stride: 1},
		...
		{Lo: 0x1e5f0, Hi: 0x1e5ff, Stride: 15},
		...
		{Lo: 0x1f16a, Hi: 0x1f16f, Stride: 1},
		{Lo: 0x1f1ad, Hi: 0x1f39c, Stride: 495},
		{Lo: 0x1f39d, Hi: 0x1f3b5, Stride: 24},
		{Lo: 0x1f3b6, Hi: 0x1f3bc, Stride: 6},
		{Lo: 0x1f4a0, Hi: 0x1f4a4, Stride: 2},
		...
		{Lo: 0x1f8b0, Hi: 0x1f8bb, Stride: 1},
		{Lo: 0x1f8c0, Hi: 0x1f8c1, Stride: 1},
		{Lo: 0x1f8d0, Hi: 0x1f8d8, Stride: 1},
		{Lo: 0x1f900, Hi: 0x1f90b, Stride: 1},
		{Lo: 0x1fa00, Hi: 0x1fa57, Stride: 1},
		{Lo: 0x1fb00, Hi: 0x1fb92, Stride: 1},
		{Lo: 0x1fb94, Hi: 0x1fbef, Stride: 1},
...
<<<<<<<< HEAD:internal/unicodedata/line_break_test.go
// Aksara_Prebase
var BreakAP = &unicode.RangeTable{
	R32: []unicode.Range32{
		{Lo: 0x11003, Hi: 0x11004, Stride: 1},
		{Lo: 0x113d1, Hi: 0x1193f, Stride: 1390},
		{Lo: 0x11941, Hi: 0x11f02, Stride: 1473},
	},
}

// Aksara_Start
var BreakAS = &unicode.RangeTable{
	R16: []unicode.Range16{
		{Lo: 0x1b50, Hi: 0x1b59, Stride: 1},
		{Lo: 0x1bc0, Hi: 0x1be5, Stride: 1},
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x11350, Hi: 0x1135e, Stride: 14},
		{Lo: 0x1135f, Hi: 0x11380, Stride: 33},
		{Lo: 0x11381, Hi: 0x11389, Stride: 1},
		{Lo: 0x1138b, Hi: 0x1138e, Stride: 3},
		{Lo: 0x11390, Hi: 0x11391, Stride: 1},
		{Lo: 0x11950, Hi: 0x11959, Stride: 1},
		{Lo: 0x11ee0, Hi: 0x11ef1, Stride: 1},
...
var BreakCL = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0xfd3e, Hi: 0xfe10, Stride: 210},
		{Lo: 0xfe11, Hi: 0xfe12, Stride: 1},
		{Lo: 0xfe18, Hi: 0xfe36, Stride: 30},
		{Lo: 0xfe38, Hi: 0xfe44, Stride: 2},
...
var BreakGL = &unicode.RangeTable{
	R16: []unicode.Range16{
		{Lo: 0x00a0, Hi: 0x035c, Stride: 700},
		{Lo: 0x035d, Hi: 0x0362, Stride: 1},
		{Lo: 0x0f08, Hi: 0x0f0c, Stride: 4},
		{Lo: 0x0f12, Hi: 0x0fd9, Stride: 199},
		{Lo: 0x0fda, Hi: 0x180e, Stride: 2100},
		{Lo: 0x1aeb, Hi: 0x1dcd, Stride: 738},
		{Lo: 0x1dfc, Hi: 0x2007, Stride: 523},
		{Lo: 0x2011, Hi: 0x202f, Stride: 30},
		{Lo: 0xfe20, Hi: 0xfe26, Stride: 2},
		{Lo: 0xfe27, Hi: 0xfe2d, Stride: 2},
		{Lo: 0xfe2e, Hi: 0xfe2e, Stride: 1},
	},
	R32: []unicode.Range32{
...
var BreakNS = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0xa015, Hi: 0xfe13, Stride: 24062},
		{Lo: 0xfe14, Hi: 0xfe54, Stride: 64},
...
// Virama Final
var BreakVF = &unicode.RangeTable{
	R16: []unicode.Range16{
...
// Virama
var BreakVI = &unicode.RangeTable{
	R16: []unicode.Range16{
		{Lo: 0x1b44, Hi: 0xa9c0, Stride: 36476},
	},
	R32: []unicode.Range32{
		{Lo: 0x11046, Hi: 0x1134d, Stride: 775},
...
var BreakID = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x113b7, Hi: 0x113d3, Stride: 28},
		{Lo: 0x113d4, Hi: 0x113d5, Stride: 1},
		{Lo: 0x113d7, Hi: 0x113d8, Stride: 1},
		{Lo: 0x11f45, Hi: 0x11f4f, Stride: 1},
		{Lo: 0x16ff4, Hi: 0x16ff6, Stride: 1},
		{Lo: 0x17000, Hi: 0x18aff, Stride: 1},
		{Lo: 0x18d00, Hi: 0x18d1e, Stride: 1},
		...
		{Lo: 0x1f774, Hi: 0x1f776, Stride: 1},
		{Lo: 0x1f77b, Hi: 0x1f77f, Stride: 1},
		...
		{Lo: 0x1fa58, Hi: 0x1fac2, Stride: 1},
...
var BreakBA = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0x00ad, Hi: 0x0964, Stride: 2231},
		...
		{Lo: 0x1361, Hi: 0x1680, Stride: 799},
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x10ed0, Hi: 0x11047, Stride: 375},
		...
		{Lo: 0x16b44, Hi: 0x16d6e, Stride: 554},
		{Lo: 0x16d6f, Hi: 0x16e97, Stride: 296},
...
var BreakCM = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0xfe21, Hi: 0xfe25, Stride: 2},
		{Lo: 0xfe28, Hi: 0xfe2c, Stride: 2},
		{Lo: 0xfe2f, Hi: 0xfff9, Stride: 458},
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x113cc, Hi: 0x113cf, Stride: 1},
		{Lo: 0x113d2, Hi: 0x113e1, Stride: 15},
		{Lo: 0x113e2, Hi: 0x11435, Stride: 83},
		{Lo: 0x11436, Hi: 0x11446, Stride: 1},
...
// Unambiguous Hyphen
>>>>>>>> main:internal/unicodedata/line_break.go
var BreakHH = &unicode.RangeTable{
	R16: []unicode.Range16{
		{Lo: 0x058a, Hi: 0x05be, Stride: 52},
		{Lo: 0x1400, Hi: 0x2010, Stride: 3088},
		{Lo: 0x2012, Hi: 0x2013, Stride: 1},
		{Lo: 0x2e17, Hi: 0x2e40, Stride: 41},
		{Lo: 0x2e5d, Hi: 0x2e5d, Stride: 1},
	},
	R32: []unicode.Range32{
		{Lo: 0x10d6e, Hi: 0x10ead, Stride: 319},
	},
}
