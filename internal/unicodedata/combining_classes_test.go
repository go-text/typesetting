...
var combiningClasses = [256]*unicode.RangeTable{
	0: {
		R16: []unicode.Range16{
			...
			{Lo: 0xa700, Hi: 0xa7dc, Stride: 1},
			{Lo: 0xa7f1, Hi: 0xa805, Stride: 1},
			...
			{Lo: 0xfb47, Hi: 0xfdcf, Stride: 1},
			{Lo: 0xfdf0, Hi: 0xfe19, Stride: 1},
		...
		R32: []unicode.Range32{
			...
			{Lo: 0x10d40, Hi: 0x10d65, Stride: 1},
			{Lo: 0x10d6e, Hi: 0x10d85, Stride: 1},
			{Lo: 0x10d8e, Hi: 0x10d8f, Stride: 1},
			{Lo: 0x10e60, Hi: 0x10e7e, Stride: 1},
			{Lo: 0x10e80, Hi: 0x10ea9, Stride: 1},
			{Lo: 0x10ead, Hi: 0x10eb0, Stride: 3},
			{Lo: 0x10eb1, Hi: 0x10ec2, Stride: 17},
			{Lo: 0x10ec3, Hi: 0x10ec7, Stride: 1},
			{Lo: 0x10ed0, Hi: 0x10ed8, Stride: 1},
			{Lo: 0x10efc, Hi: 0x10f00, Stride: 4},
			...
			{Lo: 0x11f43, Hi: 0x11f5a, Stride: 1},
			...
			{Lo: 0x16100, Hi: 0x1612e, Stride: 1},
			...
			{Lo: 0x16d40, Hi: 0x16d79, Stride: 1},
			...
			{Lo: 0x1cc00, Hi: 0x1ccfc, Stride: 1},
			...
			{Lo: 0x1e5f0, Hi: 0x1e5fa, Stride: 1},
			{Lo: 0x1e5ff, Hi: 0x1e6c0, Stride: 193},
			...
			{Lo: 0x1f300, Hi: 0x1f6d8, Stride: 1},
			...
			{Lo: 0x1fb94, Hi: 0x1fbfa, Stride: 1},
	...
	9: {
		...
		R32: []unicode.Range32{
			...
			{Lo: 0x1134d, Hi: 0x113ce, Stride: 129},
			{Lo: 0x113cf, Hi: 0x113d0, Stride: 1},
			...
			{Lo: 0x11d97, Hi: 0x11f41, Stride: 426},
			{Lo: 0x11f42, Hi: 0x1612f, Stride: 16877},
		},
	}, // size 322 B.
	10: {
		R16: []unicode.Range16{
	...
	220: {
		...
		R32: []unicode.Range32{
			...
			{Lo: 0x10ae6, Hi: 0x10efa, Stride: 1044},
			{Lo: 0x10efb, Hi: 0x10efd, Stride: 2},
			...
			{Lo: 0x1e4ee, Hi: 0x1e5ef, Stride: 257},
	...
	230: {
		R16: []unicode.Range16{
			...
			{Lo: 0x0897, Hi: 0x0898, Stride: 1},
			{Lo: 0x089c, Hi: 0x089f, Stride: 1},
			...
			{Lo: 0x1acb, Hi: 0x1adc, Stride: 1},
			{Lo: 0x1ae0, Hi: 0x1ae5, Stride: 1},
			{Lo: 0x1ae7, Hi: 0x1aea, Stride: 1},
		...
		R32: []unicode.Range32{
			...
			{Lo: 0x1e4ef, Hi: 0x1e5ee, Stride: 255},
			{Lo: 0x1e6e3, Hi: 0x1e6e6, Stride: 3},
			{Lo: 0x1e6ee, Hi: 0x1e6ef, Stride: 1},
			{Lo: 0x1e6f5, Hi: 0x1e944, Stride: 591},
