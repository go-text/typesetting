...
var GraphemeBreakExtend = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1193c, Hi: 0x1193e, Stride: 1},
...
var GraphemeBreakPrepend = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x11941, Hi: 0x11a84, Stride: 323},
...
var GraphemeBreakSpacingMark = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0x0cbe, Hi: 0x0cc1, Stride: 3},
		{Lo: 0x0cc3, Hi: 0x0cc4, Stride: 1},
		...
		{Lo: 0x1b04, Hi: 0x1b3e, Stride: 58},
		{Lo: 0x1b3f, Hi: 0x1b41, Stride: 1},
		{Lo: 0x1b82, Hi: 0x1ba1, Stride: 31},
		{Lo: 0x1ba6, Hi: 0x1ba7, Stride: 1},
		{Lo: 0x1be7, Hi: 0x1bea, Stride: 3},
		{Lo: 0x1beb, Hi: 0x1bec, Stride: 1},
		{Lo: 0x1bee, Hi: 0x1c24, Stride: 54},
		...
		{Lo: 0xa952, Hi: 0xa9b4, Stride: 49},
		{Lo: 0xa9b5, Hi: 0xa9ba, Stride: 5},
		{Lo: 0xa9bb, Hi: 0xa9be, Stride: 3},
		{Lo: 0xa9bf, Hi: 0xaa2f, Stride: 112},
		{Lo: 0xaa30, Hi: 0xaa33, Stride: 3},
		{Lo: 0xaa34, Hi: 0xaa4d, Stride: 25},
		{Lo: 0xaaeb, Hi: 0xaaee, Stride: 3},
		{Lo: 0xaaef, Hi: 0xaaf5, Stride: 6},
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x111bf, Hi: 0x111ce, Stride: 15},
		...
		{Lo: 0x113ca, Hi: 0x113cc, Stride: 2},
		{Lo: 0x113cd, Hi: 0x11435, Stride: 104},
		...
		{Lo: 0x1171e, Hi: 0x11726, Stride: 8},
...
var GraphemeBreakV = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		{Lo: 0x16d63, Hi: 0x16d67, Stride: 4},
		{Lo: 0x16d68, Hi: 0x16d6a, Stride: 1},
	},
}
...
var graphemeBreakAll = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x11357, Hi: 0x11357, Stride: 10},
		{Lo: 0x11362, Hi: 0x11363, Stride: 1},
		{Lo: 0x11366, Hi: 0x1136c, Stride: 1},
		{Lo: 0x11370, Hi: 0x11374, Stride: 1},
		...
		{Lo: 0x113cc, Hi: 0x113d2, Stride: 1},
		...
		{Lo: 0x16fe4, Hi: 0x16ff0, Stride: 12},
		{Lo: 0x16ff1, Hi: 0x1bc9d, Stride: 19628},
		{Lo: 0x1bc9e, Hi: 0x1bc9e, Stride: 1},
		{Lo: 0x1bca0, Hi: 0x1bca3, Stride: 1},
